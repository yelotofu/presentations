...
// 2007-1-26: Added Relative Link Patch
// 2007-1-30: Fixed Relative Link Patch
/************************ ADDITIONAL FEATURES ************************
...
s.linkInternalFilters="javascript:,apple.com,www.mac.com"
...
function s_doPlugins(s) {
	...
	// Campaign Pathing
	s.prop6=s.getQueryParam('cp')+": "+document.title;
	...
	if (typeof(AC) == "undefined") {AC = {};}
		AC.AosCheck = function() {
			if (typeof(s) != "undefined") {
				...
				if (mv > 400) s.prop9 = "10.4.x";
				else if (mv > 99) s.prop9 = "10.3.x";
				else if (mv > 80) s.prop9 = "10.2.x";
				else s.prop9 = "unknown or non-safari"; 
			}
		}
		...
		AC.AosCheck();
	// Mac OS X Versions: 2007-06-08 : End
...
/*
 * Plugin: setClickMapEmail - sets ClickMap variables w/ q-string values
 */
s.setClickMapEmail=new Function("qp",""
+"var s=this,v=s.getQueryParam(qp,'~'),d,pn,oid,cv;d=v.indexOf('~');if"
+"(!v)return '';if(d>-1){pn=v.substring(0,d);oid=v.substring(d+1);}cv="
+"'&pid='+s.ape(s.fl(pn,255))+'&pidt=1&oid='+s.ape(s.fl(oid,100))+'&oi"
+"dt=1&ot=A&oi=1';s.sq(cv);");
/*
